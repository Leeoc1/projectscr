...
--                     WHEN movienm = '라이언일병 구하기' THEN 'http://file.koreafilm.or.kr/thm/02/99/19/03/tn_DPF031411.jpg'
--                     ELSE posterurl
--         END
-- WHERE movienm IN (
