...
import { getReservationInfo, getSelectedMovie, setReservationInfo } from "../utils/reservationStorage";
import { generateFilteredData } from "../utils/scheduleUtils";
import { validateReservationInfo, validateScheduleData } from "../utils/validationUtils";
...
export const useReservation = () => {
  ...
  useEffect(() => {
    ...
    const isMovieActuallySelected = selectedMovie && 
    ...
    setReservationState(prev => ({
      ...
      selectedDate: savedInfo.selectedDate ? new Date(savedInfo.selectedDate) : new Date(),
  ...
  const loadSchedules = useCallback(async () => {
    try {
      setReservationState(prev => ({ ...prev, isLoading: true, error: null }));
  ...
  }, [schedules, reservationState.selectedMovie, reservationState.selectedDate, 
